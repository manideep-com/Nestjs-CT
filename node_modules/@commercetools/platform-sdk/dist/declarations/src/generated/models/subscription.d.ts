 ...
 */
export declare enum AwsAuthenticationModeValues {
 ...
 *
 */
export declare enum ChangeSubscriptionResourceTypeIdValues {
...
export type EventType = 'CheckoutOrderCreationFailed' | 'CheckoutPaymentAuthorizationCancelled' | 'CheckoutPaymentAuthorizationFailed' | 'CheckoutPaymentAuthorized' | 'CheckoutPaymentCancelAuthorizationFailed' | 'CheckoutPaymentChargeFailed' | 'CheckoutPaymentCharged' | 'CheckoutPaymentRefundFailed' | 'CheckoutPaymentRefunded' | 'ImportContainerCreated' | 'ImportContainerDeleted' | 'ImportOperationRejected' | 'ImportUnresolved' | 'ImportValidationFailed' | 'ImportWaitForMasterVariant' | (string & {});
/**
 ...
 *
 */
export declare enum MessageSubscriptionResourceTypeIdValues {
    ApprovalFlow = "approval-flow",
    ApprovalRule = "approval-rule",
    AssociateRole = "associate-role",
    BusinessUnit = "business-unit",
 ...
 *
 */
export declare enum SubscriptionHealthStatusValues {
