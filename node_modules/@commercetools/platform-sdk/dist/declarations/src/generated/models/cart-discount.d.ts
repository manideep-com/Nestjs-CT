...
import { BaseResource, CentPrecisionMoney, CreatedBy, IReference, IResourceIdentifier, LastModifiedBy, LocalizedString, Money, Reference, TypedMoney, TypedMoneyDraft } from "./common.js";
...
export type CartDiscountTarget = CartDiscountCustomLineItemsTarget | CartDiscountLineItemsTarget | CartDiscountPatternTarget | CartDiscountShippingCostTarget | CartDiscountTotalPriceTarget | MultiBuyCustomLineItemsTarget | MultiBuyLineItemsTarget;
 ...
 *
 */
export declare enum DiscountApplicationModeValues {
 ...
 *
 */
export declare enum SelectionModeValues {
    Cheapest = "Cheapest",
 ...
 *
 */
export declare enum StackingModeValues {
    Stacking = "Stacking",
