 ...
 */
export declare enum SearchFieldTypeValues {
    Boolean = "boolean",
    Date = "date",
    Datetime = "datetime",
    Enum = "enum",
...
export type SearchFieldType = 'boolean' | 'date' | 'datetime' | 'enum' | 'lenum' | 'ltext' | 'money' | 'number' | 'reference' | 'set_boolean' | 'set_date' | 'set_datetime' | 'set_enum' | 'set_lenum' | 'set_ltext' | 'set_money' | 'set_number' | 'set_reference' | 'set_text' | 'set_time' | 'text' | 'time' | (string & {});
export declare enum SearchMatchTypeValues {
    All = "all",
    Any = "any"
}
...
export type _SearchQueryExpressionValue = SearchQueryExpressionValue | SearchAnyValue | SearchDateRangeValue | SearchDateTimeRangeValue | SearchExactValue | SearchExistsValue | SearchFullTextPrefixValue | SearchFullTextValue | SearchLongRangeValue | SearchNumberRangeValue | SearchTimeRangeValue;
 ...
 *
 */
export declare enum SearchSortModeValues {
    Avg = "avg",
    Max = "max",
    Min = "min",
    Sum = "sum"
...
export declare enum SearchSortOrderValues {
    Asc = "asc",
    Desc = "desc"
}
