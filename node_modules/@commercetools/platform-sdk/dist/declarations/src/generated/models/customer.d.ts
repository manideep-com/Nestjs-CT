...
import { Address, BaseAddress, BaseResource, CreatedBy, IReference, IResourceIdentifier, LastModifiedBy, _BaseAddress } from "./common.js";
...
export declare enum AnonymousCartSignInModeValues {
...
export declare enum AuthenticationModeValues {
...
export type CustomerUpdateAction = CustomerAddAddressAction | CustomerAddBillingAddressIdAction | CustomerAddCustomerGroupAssignmentAction | CustomerAddShippingAddressIdAction | CustomerAddStoreAction | CustomerChangeAddressAction | CustomerChangeEmailAction | CustomerRemoveAddressAction | CustomerRemoveBillingAddressIdAction | CustomerRemoveCustomerGroupAssignmentAction | CustomerRemoveShippingAddressIdAction | CustomerRemoveStoreAction | CustomerSetAddressCustomFieldAction | CustomerSetAddressCustomTypeAction | CustomerSetAuthenticationModeAction | CustomerSetCompanyNameAction | CustomerSetCustomFieldAction | CustomerSetCustomTypeAction | CustomerSetCustomerGroupAction | CustomerSetCustomerGroupAssignmentsAction | CustomerSetCustomerNumberAction | CustomerSetDateOfBirthAction | CustomerSetDefaultBillingAddressAction | CustomerSetDefaultShippingAddressAction | CustomerSetExternalIdAction | CustomerSetFirstNameAction | CustomerSetKeyAction | CustomerSetLastNameAction | CustomerSetLocaleAction | CustomerSetMiddleNameAction | CustomerSetSalutationAction | CustomerSetStoresAction | CustomerSetTitleAction | CustomerSetVatIdAction;
