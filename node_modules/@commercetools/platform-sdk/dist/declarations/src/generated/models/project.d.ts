 ...
 *
 */
export declare enum BusinessUnitIndexingStatusValues {
    Failed = "Failed",
    Indexing = "Indexing",
    Ready = "Ready",
    Scheduled = "Scheduled"
 ...
 *
 */
export declare enum CustomerIndexingStatusValues {
    Failed = "Failed",
    Indexing = "Indexing",
    Ready = "Ready",
    Scheduled = "Scheduled"
 ...
 */
export declare enum BusinessUnitConfigurationStatusValues {
    Active = "Active",
    Inactive = "Inactive"
}
 ...
 *
 */
export declare enum BusinessUnitSearchStatusValues {
    Activated = "Activated",
 ...
 *
 */
export declare enum CustomerSearchStatusValues {
    Activated = "Activated",
    Deactivated = "Deactivated"
}
 ...
 */
export declare enum OrderSearchStatusValues {
    Activated = "Activated",
    Deactivated = "Deactivated"
}
export type OrderSearchStatus = 'Activated' | 'Deactivated' | (string & {});
export declare enum ProductSearchIndexingModeValues {
...
export type ProjectUpdateAction = ProjectChangeBusinessUnitSearchStatusAction | ProjectChangeBusinessUnitStatusOnCreationAction | ProjectChangeCartsConfigurationAction | ProjectChangeCountriesAction | ProjectChangeCountryTaxRateFallbackEnabledAction | ProjectChangeCurrenciesAction | ProjectChangeCustomerSearchStatusAction | ProjectChangeLanguagesAction | ProjectChangeMessagesConfigurationAction | ProjectChangeNameAction | ProjectChangeOrderSearchStatusAction | ProjectChangePriceRoundingModeAction | ProjectChangeProductSearchIndexingEnabledAction | ProjectChangeShoppingListsConfigurationAction | ProjectChangeTaxRoundingModeAction | ProjectSetBusinessUnitAssociateRoleOnCreationAction | ProjectSetExternalOAuthAction | ProjectSetShippingRateInputTypeAction;
 ...
 */
export declare enum SearchIndexingConfigurationStatusValues {
    Activated = "Activated",
    Deactivated = "Deactivated",
    Indexing = "Indexing"
}
