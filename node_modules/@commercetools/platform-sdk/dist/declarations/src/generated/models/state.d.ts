 ...
 *
 */
export declare enum StateRoleEnumValues {
    Return = "Return",
 ...
 *
 */
export declare enum StateTypeEnumValues {
...
export type StateTypeEnum = 'LineItemState' | 'OrderState' | 'PaymentState' | 'ProductState' | 'QuoteRequestState' | 'QuoteState' | 'RecurringOrderState' | 'ReviewState' | 'StagedQuoteState' | (string & {});
